...
<html>
    <head>
        <title>Search opera by year</title>
        <style>
            img{
                float: right;
                width: 10cm;
    ...
    $query = "SELECT opera.Title, author.Name, author.Surname, opera.image, opera.Year, opera.Description FROM author INNER JOIN opera ON author.idAuthor = opera.codAuthor WHERE opera.Year = '" . $year . "';";
