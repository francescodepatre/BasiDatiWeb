...
<html>
    <head>
        <title>Search artist by birth year</title>
        <style>
            img{
                float: left;
            }
    ...
    $query = "SELECT author.Name, author.Surname, author.BirthYear, author.BirthPlace, author.Biography FROM author WHERE author.BirthYear = '" . $year . "';";
