...
<html>
    <head>
        <title>Search opera by artist surname</title>
        <style>
            img{
                float: right;
                width: 10cm;
    ...
    $query = "SELECT opera.Title, author.Name, author.Surname, opera.Year, opera.image, opera.Description FROM author INNER JOIN opera ON author.idAuthor = opera.codAuthor WHERE author.Surname = '" . $surname . "';";
