...
<html>
    ...
    $query = "SELECT artshow.Title, artshow.Type, artshow.Description, artshow.DateAndTimeStart artshow.DateAndTimeEnd FROM artshow WHERE artshow.DateAndTimeStart = '" . $time . "' OR artshow.DateAndTimeEnd = '" . $time . "';";
